...
EMAIL_HOST_USER = 'q614895416@163.com'    # 发送邮件的邮箱地址
EMAIL_HOST_PASSWORD = 'q614895416'   # 发送邮件的邮箱密码(这里使用的是授权码)
EMAIL_PROM = '天天生鲜<q614895416@163.com>'  # 收件人看到的发件人
...
FDFS_URL = 'http://192.168.128.129:8888/'
